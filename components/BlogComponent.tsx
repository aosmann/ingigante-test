...
// Define a Blog interface (you can expand this as needed)
interface Blog {
  _id: string;
  title: string;
  description: string;
  ...
  mainImage: any; // Ideally replace this with a proper image asset type if available
  publishedAt: string;
}
            ...
            <Link key={blog._id} href={`/blog/${blog.slug.current}`}>
              <div className="flex flex-col cursor-pointer group">
                ...
                <div className="mt-5 flex-1">
                  ...
                  <p className="line-clamp-2 text-gray-500 text-justify">{blog.description}</p>
                </div>
