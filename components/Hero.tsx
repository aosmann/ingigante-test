...
const Hero = ({ propertyType, locations }) => {
  ...
  <div
    className="absolute inset-0 bg-cover bg-center bg-no-repeat before:content-[''] before:absolute before:inset-0 before:bg-gradient-to-r before:from-black/80 before:via-black/40 before:to-transparent before:z-10"
    style={{
  ...
  {/* Content Container */}
  <div className="relative z-20 max-w-7xl mx-auto px-4 flex flex-col lg:flex-row items-center justify-between gap-10">
    {/* Left Text */}
    <div className="flex-1 text-white text-center lg:text-left space-y-4">
      ...
      <p className="text-sm sm:text-base lg:text-lg font-light leading-relaxed max-w-xl mx-auto lg:mx-0">
    ...
    {/* Optional Right Image - if needed */}
    <div className="flex-shrink-0 hidden lg:block">
      <Image
        src={hero} // keep if needed
        alt="Hero Image"
        className="w-[280px] sm:w-[380px] md:w-[420px] lg:w-[500px] xl:w-[550px] 2xl:w-[600px]"
      />
    </div>
  </div>
